...
public class PoTranslator
{
    ...
    private static Dictionary<string, string> dictExact = new Dictionary<string, string>(StringComparer.OrdinalIgnoreCase)
    {
        ...
        { "Are you sure you want to clear the assignments?", "Bạn có chắc chắn muốn xóa phân công này không?" },
        { "Please save the document before removing assignment", "Vui lòng lưu tài liệu trước khi xóa phân công" },
        { "Select records for removing assignment", "Chọn bản ghi để xóa phân công" },
        { "Your assignment on task {0} has been removed by {1}", "Phân công của bạn trên công việc {0} đã bị xóa bởi {1}" },
        { "Your assignment on {0} {1} has been removed by {2}", "Phân công của bạn trên {0} {1} đã bị xóa bởi {2}" },
        { "{0} removed their assignment.", "{0} đã xóa phân công của họ." },
